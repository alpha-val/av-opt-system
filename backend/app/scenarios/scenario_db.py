...
from app.scenarios.scenario_model import (
    ScenarioInDB,
    ScenarioCreate,
    ScenarioUpdate,
    ScenarioResponse,
...
def create_scenario_db(
    scenario_data: Dict[str, Any], project_id: str, user_id: str
) -> ScenarioInDB:
    """Create a new scenario in database"""
    # scenario_data is already a dict from model_dump()
    scenario_data["properties.project_id"] = project_id
    scenario_data["properties.created_by"] = user_id
    scenario_data["properties.created_at"] = datetime
    scenario_data["properties.updated_at"] = datetime
...
def update_option_db(option_id: str, update_data: OptionUpdate) -> Optional[OptionInDB]:
    """Update an option"""
    # Get existing option
