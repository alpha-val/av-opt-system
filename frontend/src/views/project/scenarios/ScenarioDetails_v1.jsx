...
const ScenarioDetail = ({
  ...
  const handleDelete = async () => {
    ...
    const confirmed = await dialogs.confirm(
      `Are you sure you want to delete scenario "${scenario.name}"? This action cannot be undone.`,
      {
    ...
    if (confirmed) {
      try {
        ...
        console.log("[ScenarioDetails] Scenario deleted:", scenarioId);

        // Navigate back to list
        if (onClose) onClose();
      } catch (error) {
        console.error("[ScenarioDetails] Failed to delete scenario:", error);
